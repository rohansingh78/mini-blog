  ...
  return (
    <Navbar isBordered isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen}>
      <NavbarContent className="sm:hidden" justify="start">
        <NavbarMenuToggle aria-label={isMenuOpen ? "Close menu" : "Open menu"} onClick={() => isSearchOpen?setIsSearchOpen(!isSearchOpen):''}/>
      </NavbarContent>
      ...
      <NavbarContent justify="end">
        <NavbarItem className={isSearchOpen?'hidden':'block'}>
